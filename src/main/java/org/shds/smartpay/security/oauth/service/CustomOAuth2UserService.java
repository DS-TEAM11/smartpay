package org.shds.smartpay.security.oauth.service;
...
import org.shds.smartpay.security.oauth.OAuthAttributes;
...
//        SocialType socialType = getSocialType(registrationId);
        ...
        Member createdMember = getMember(extractAttributes); // getUser() 메소드로 Member 객체 생성 후 반환
    ...
    private Member saveMember(OAuthAttributes attributes) {
        log.info("CustomOAuth2UserService는 들어와짐? 여기에서 소셜ID,타입이 저장되어야 하는 : {}", attributes.getOauth2UserInfo().getEmail());
